...
test = pd.read_csv('../input/test.v02.csv')
weather = pd.read_csv('../input/weather.csv')

# Get labels
labels = train.WnvPresent.values
test_labels = test.WnvPresent.values
...
test = test.drop(['Address', 'AddressNumberAndStreet','WnvPresent', 'NumMosquitos'], axis = 1)
...
print "Number of samples:", len(test_labels), len(predictions)
